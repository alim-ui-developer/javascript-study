...
function play(){
  ...
  if(userValue < minNum || userValue > maxNum){
    resultArea.textContent = `${minNum}과 ${maxNum}사이 숫자를 입력해주세요`;
    return;
  }
...
function reset(){
  ...
  chances = initialChance;
  resultArea.textContent = initialText;
}
